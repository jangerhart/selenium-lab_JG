...
- Before architectural or database-related changes, read `docs/PROJECT_CONTEXT.md` and `docs/HANDOFF.md`.
...
- After every meaningful completed task, update `docs/HANDOFF.md`.
- `docs/HANDOFF.md` must cover: current state, files changed, database objects inspected or changed, tests executed, results, unresolved issues, and the recommended next step.
- Do not delete previous important architectural decisions from `docs/PROJECT_CONTEXT.md`.
